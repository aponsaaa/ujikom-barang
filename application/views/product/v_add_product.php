            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        ...
                        <?= form_open_multipart('product/add-product'); ?>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Nama Produk</label>
                            <input type="text" name="nama" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?= set_value('nama') ?>">
                            <badge class="text-danger text-xs"><?= form_error('nama') ?></badge>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Harga</label>
                            <input type="number" name="harga" class="form-control" id="exampleInputPassword1" value="<?= set_value('harga') ?>">
                            <badge class="text-danger text-xs"><?= form_error('harga') ?></badge>

                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Foto Produk</label>
                            <input type="file" name="fotoProduk" class="form-control" id="exampleInputPassword1">
                            <badge class="text-danger text-xs"><?= form_error('fotoProduk') ?></badge>
                        </div>
